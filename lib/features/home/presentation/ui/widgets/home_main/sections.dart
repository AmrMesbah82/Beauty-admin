...
// Description: Section widgets for Home main
        ...
        return Column(
          ...
          children: [
            ...
            Row(children: [
              ...
              SizedBox(width: 16.w),
              Expanded(
                  child: _readFieldRtl('عنوان المجموعة', col.title.ar)),
            ]),
            SizedBox(height: 8.h),
            Row(children: [
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Expanded(
                          child:
                              _readFieldRtl('التسمية', lbl.label.ar)),
                    ]),
                  ],
                ),
              ),
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Expanded(
                child: _readField('Navigation Label',
                    appLinks.labelEn.isEmpty ? 'Text Here' : appLinks.labelEn)),
            SizedBox(width: 16.w),
            Expanded(
                child: _readFieldRtl('تسمية التنقل', appLinks.labelAr)),
          ],
        ),
        SizedBox(height: 16.h),
        Row(
