// ******************* FILE INFO *******************
// File Name: social_link_dropdown.dart
// Description: Social link dropdown for Contact Us edit
        ...
        child: Row(
          children: [
            if (link.iconUrl.isNotEmpty)
              _buildIcon(link.iconUrl, hasUrl ? ColorPick.primary : Colors.grey.shade400)
            else
              Icon(Icons.link,
                  size:  16.sp,
    ...
    Widget selectedDisplay() {
      ...
      return Row(children: [
        if (selectedLink.iconUrl.isNotEmpty)
          _buildIcon(selectedLink.iconUrl, ColorPick.primary)
        else
