...
// Description: Preview content widget for Contact Us preview
...
class _PreviewContent extends StatefulWidget {
  ...
  const _PreviewContent({
    ...
    required this.data,
    required this.isEnglish,  // ← add this line
    this.isMobile = false,
  });
            ...
            SizedBox(
              ...
              child: data.headings.svgUrl.isNotEmpty
                  ...
                  placeholderBuilder: (_) =>
                      Icon(Icons.image_outlined, size: 60, color: ColorPick.primary))
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: selected ? ColorPick.primary : Colors.grey.shade400,
                      width: 2,
                    ),
                  ),
                  child: selected
